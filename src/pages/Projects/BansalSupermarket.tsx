  ...
  const projectContent = {
    ...
    images: [
      ...
      },
      {
        ...
        caption:
          'Scatter plot showing the relationship between sales volume and profit margin across product categories.',
      },
      {
        src: '/images/projects/Bansal_Project2/bs-stockTO.webp',
        alt: 'Stock Turnover Analysis',
        caption:
          'Visualization of stock turnover rates by product category to optimize inventory management.',
      },
      {
      ...
      {
        src: '/images/projects/Bansal_Project2/bs2-Dashboard.webp',
        alt: 'Top 10 Products by Sales',
        caption: 'Bar chart displaying the top 10 best-selling products by total sales value.',
      },
      {
