...
const SkillsSection = () => {
  ...
  return (
    <section id="skills" className="py-16 sm:py-24 lg:py-32 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-muted-foreground max-w-2xl mx-auto text-base sm:text-lg">
            My diverse skill set enables me to excel in various professional roles, delivering exceptional results across different domains.
          </p>
        </motion.div>
