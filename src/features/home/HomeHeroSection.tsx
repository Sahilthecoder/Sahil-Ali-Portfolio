...
const HomeHeroSection = () => {
  ...
  return (
    <div className="relative min-h-[calc(100vh-80px)] w-full flex items-center justify-center overflow-x-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_0%,rgba(0,0,0,0.02)_70%)] dark:bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.01)_0%,rgba(0,0,0,0.1)_70%)] pointer-events-none" />
      
      {/* Main Content */}
      <div className="container mx-auto px-4 sm:px-6 relative z-10 py-16 sm:pt-20">
